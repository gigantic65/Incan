...
def app():
    ...
    df1 = pd.read_csv('train_n1.csv')
    models1 = load_model('model_n1.h5')
    scaler1 = pickle.load(open('./scaler_n1.pkl', 'rb'))
    
    df2 = pd.read_csv('train_n2.csv')
    models2 = load_model('model_n2.h5')
    scaler2 = pickle.load(open('./scaler_n2.pkl', 'rb'))
    
    df3 = pd.read_csv('train_n3.csv')
    models3 = load_model('model_n3.h5')
    scaler3 = pickle.load(open('./scaler_n3.pkl', 'rb'))
    
    df4 = pd.read_csv('train_n4.csv')
    models4 = load_model('model_n4.h5')
    scaler4 = pickle.load(open('./scaler_n4.pkl', 'rb'))
    
    df5 = pd.read_csv('train_n5.csv')
    models5 = load_model('model_n5.h5')
    scaler5 = pickle.load(open('./scaler_n5.pkl', 'rb'))
    
    df6 = pd.read_csv('train_n6.csv')
    models6 = load_model('model_n6.h5')
    scaler6 = pickle.load(open('./scaler_n6.pkl', 'rb'))
    
    
    df7 = pd.read_csv('train_n7.csv')
    models7 = load_model('model_n7.h5')
    scaler7 = pickle.load(open('./scaler_n7.pkl', 'rb'))
    
    df8 = pd.read_csv('train_n8.csv')
    models8 = load_model('model_n8.h5')
    scaler8 = pickle.load(open('./scaler_n8.pkl', 'rb'))
    ...
    if st.button('Run Prediction',key = 2):
        ...
        if ques == '기존배합 수정설계':
            ...
            # 결과만 보여지게 하기 위해
            para4['Pred_L'] = DT['Target_L']
            para4['Pred_a'] = DT['Target_a']
            para4['Pred_b'] = DT['Target_b']
